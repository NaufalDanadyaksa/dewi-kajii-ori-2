...
<form action='{{ route('ikan.update', $ikan->id) }}' method='post' enctype="multipart/form-data">
    ...
    <div class="my-3 p-3 bg-body rounded shadow-sm">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name='name' value="{{ $ikan->name }}" id="name">
            </div>
        </div>
        <div class="mb-3 row">
            <label for="price" class="col-sm-2 col-form-label">Price</label>
            <div class="col-sm-10">
                <input type="number" class="form-control" name='price' value="{{ $ikan->price }}" id="price">
            </div>
        </div>
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                ...
                <img src="{{ asset('posts/katalog_ikan/'.$image->url) }}" class="rounded mb-3" style="width: 50%">
