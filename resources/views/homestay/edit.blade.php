...
<form action='{{ route('homestay.update', $homestay->id) }}' method='post' enctype="multipart/form-data">
    ...
    <div class="form-group">
        <input type="text" class="form-control text-white" name='name' value="{{ $homestay->name }}" id="name" style="
 ...
 />
    ...
    <div class="form-group">
        <textarea type="text" class="form-control text-white p-3" name="description" id="description" placeholder="Nama homestay"
          style="
            background-color:  #68687D;
            text-decoration: none;
            opacity: 1;
