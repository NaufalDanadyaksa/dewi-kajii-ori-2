    ...
    <form action="{{ route('berita.update', $berita->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group" style="margin-top: 20px;">
            ...
            <input
                ...
                style=" display: none;"
            />
            <button type="button" onclick="document.getElementById('new_image').click()" class="btn text-white rounded-pill" style="background-color: #68687D; margin-top:10px; margin-bottom:10px; " id="chooseImageButton">Pilih Gambar</button>
            <div id="preview"></div>
            @if ($berita->image)
        ...
        <div class="row justify-content-end">
            <div class="col-auto">
                <button type="submit" name="submit" class="btn text-white rounded-pill py-2 px-3" style="background-color: #95959a; text-decoration: none; opacity: 1.0; box-shadow: none; border: none">Update</button>
                <a href="{{ route('berita.index') }}"  class="btn text-white rounded-pill py-2 px-3" style="background-color: #68687D;text-decoration: none; opacity: 1.0; box-shadow: none; border: none">Batal</a>
            </div>
        </div>
